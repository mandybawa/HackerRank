...
# class creates a Book object and calls the MyBook class constructor
# (passing it the necessary arguments). It then calls the display method
# on the Book object.

# Output Format:
# The void_displays() method should print and label the respective title, author, and
