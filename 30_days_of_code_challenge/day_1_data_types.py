...
# Concatenate s with the string you read as input and print the result on
# a new line.

# Note: If you are using a language that doesn't support using

# for string concatenation (e.g.: C), you can just print one variable immediately following the other on the same line.
...
# decimal place) on the second line, and then the two concatenated strings
# on the third line.
...
# In Python >= 3.6, f-string is an efficient way to concatenate a string.
# print(f"{s}{t}")
